...
namespace CSVNet.Legacy
{
    public partial class CSVDocument
    {
        ...
        public void RemoveRow()
        {
            try
            {
                if (RowExist(GetLastRowIndex()))
                {
                    Content.RemoveAt(GetLastRowIndex());
                }
                else
                {
        ...
        {
            return GetRowAs<T>(GetLastRowIndex());
        }
        ...
        public int RowIndexOf(int Index, string Value, int Start)
        {
            try
            {
                ...
                for (int I = Start; I < GetColCount(); I++)
                {
                    if (GetCell(Index, I).Contains(Value))
                    {
                        return I;
        ...
        public int RowLastIndexOf(int Index, string Value)
        {
            try
            {
                if (RowExist(Index))
                {
                    for (int I = GetLastColIndex(); I >= 0; I++)
                    {
                        if (GetCell(Index, I).Contains(Value))
                        {
                            return I;
